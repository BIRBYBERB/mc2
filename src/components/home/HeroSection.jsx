    ...
    <section className="relative overflow-hidden min-h-screen md:min-h-[85vh] flex items-center">
      ...
      <div className="md:hidden relative z-10 w-full px-4 py-8 text-center">
        ...
        <div className="mb-8 max-w-xs mx-auto">
          <div className="space-y-3">
            <div className="relative group">
              <div className="bg-white/15 backdrop-blur-2xl border border-white/25 rounded-2xl overflow-hidden shadow-xl hover:shadow-blue-500/20 transition-all duration-500 hover:scale-105">
        ...
        <div className="flex flex-col space-y-3 max-w-xs mx-auto">
          <button className="bg-gradient-to-r from-blue-600 to-blue-500 text-white px-6 py-3 rounded-2xl font-semibold shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2 text-sm">
            <span>Explore Buildings</span>
          </button>
        </div>
      </div>

      {/* DESKTOP VERSION WITHOUT RIGHT CONTENT */}
      <div className="hidden md:block relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col items-start max-w-3xl">
          ...
          <div className="flex flex-row gap-6">
            <button className="bg-gradient-to-r from-blue-600 to-blue-500 text-white px-10 py-5 rounded-2xl font-semibold shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-3 text-lg">
                <span>Explore Buildings</span>
